...
() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        bool otpSent = await apiService.sendProviderSignUpOTP(_emailController.text);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            TopImage(height: height, width: width, imagePath: 'assets/images/ProviderSignUp.png'),
            Container(
              color: Colors.white,
